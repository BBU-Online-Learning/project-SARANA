    ...
    <div class="page-container">
        ...
        <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold mb-0">Edit Role</h4>
            </div>
            <div class="text-end">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="description" rows="7">{{ $role->description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input name="status" id="status1" value="1" type="checkbox" class="form-check-input" {{ old('status',$role->status) ==1 ? 'checked': '' }}>
