        ...
        <div class="sidenav-menu">
            ...
            <div data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    @endcan
                    {{-- ================= Chat Box ================= --}}
                    <li class="side-nav-title">Chat Box</li>

                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="#sidebarChat" aria-expanded="false" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="#sidebarInventory" aria-expanded="false"
                            ...
                            <span class="menu-text">Products & Inventory</span>
                            <span class="menu-arrow"></span>
                        </a>
                    ...
                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="#sidebarFinance" aria-expanded="false"
                            class="side-nav-link">
                                    ...
                                    <div class="col-md-4">
                                        <div class="p-3">
                                            ...
                                            <ul class="list-unstyled megamenu-list">
                                                ...
                                                <li>
                                                    <a href="apps-UserManagement-doctors.html">UserManagement</a>
                                                </li>
                                                <li>
                    ...
                    <div class="topbar-item nav-user">
                        <div class="dropdown">
                            <a class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown"
                                ...
                                <img src="{{ Auth::user()->profile ?? 0 }}" width="32"
